...
public class TelaConsultaDeTipoPeca extends JFrame {
	...
	@Autowired
	private TelaCadastroDeTipoPeca telaDeCadastro;
	...
	public TelaConsultaDeTipoPeca() {
		...
		btnPesquisar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				List<TipoPeca> pecas = service.listarPor(edtFiltro.getText());
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TipoPeca pecaSelecionada = model.getPor(linhaSelecionada);
		...
		btnExcluir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int linhaSelecionada = table.getSelectedRow();
				TipoPecaTableModel model = (TipoPecaTableModel)table.getModel();
				TipoPeca pecaSalva = model.getPor(linhaSelecionada);
